...
export default function Contact({ locale, content }: { locale: Locale; content?: { title: string; description: string } }) {
  ...
  return <section id="contact" className="relative overflow-hidden border-t border-border bg-[#0c0c0b] px-5 py-24 text-[#f5f5f1] sm:px-8 md:px-12 md:py-36">
