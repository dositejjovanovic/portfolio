export const designRecognition = [
  "Contributed to a website recognised in the Top 50 selection for the best educational institution website in Serbia in 2025.",
  "Created design work for a student organisation recognised in the Top 50 selection for the best Instagram profile in Serbia in 2025.",
  "Worked on the documentary Sećanje na Mihajla Sporića, which received first prize at the international FilićFilmić film festival in 2025.",
] as const;
